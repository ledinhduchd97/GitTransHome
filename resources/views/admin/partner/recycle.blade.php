          ...
          <div class="tk-top tk-top-wrap">
            <div class="tk-top__top">
              <div class="tk-top__top--left fleft col-50">
                <h2 class="tk-top__title">Partner in Recycle Bin</h2><a class="add-new" href="{{ route('admin.partner.create') }}">Add new</a>
              </div>
                    ...
                    <div class="col-25 fleft">
                      <div class="tk-top__from-date date--wrap"><span>Start day</span>
                        <div class="fromDate date--wrap2 myDate"><i class="far fa-calendar-alt"></i>
                          <input name="date_from" class="padding--base border--base padding--date" id="startDay" type="date" value="{{ request()->date_from }}"/>
                        </div>
                      </div>
                    </div>
                    <div class="col-25 fleft">
                      <div class="tk-top__to-date date--wrap"><span>Finish day</span>
                        <div class="toDate date--wrap2 myDate"><i class="far fa-calendar-alt"></i>
                          <input name="date_to" class="padding--base border--base padding--date" id="endDay" type="date" value="{{ request()->date_to }}"/>
                        </div>
                      </div>
                    </div>
              ...
              @foreach($partners as $key => $partner)
                <tr>
                  ...
                  <td>
                    ...
                    <input type="text" value="{{$partner->fullname}}" readonly class="inputonly">
                  </td>
                  <td>
                    <!-- <p class="email">{{$partner->email}}</p> -->
                    <input type="text" value="{{$partner->email}}" readonly class="inputonly">
                  </td>
                  <td>
                    <!-- <p>{{$partner->phone}}</p> -->
                    <input type="text" value="{{$partner->phone}}" readonly class="inputonly">
                  </td>
                  <td>
                    @if(isset($partner->address))
                    <!-- <p class="address">{{$partner->address}}</p> -->
                    <input type="text" value="{{$partner->address}}" readonly class="inputonly">
                    @else
                    <p> - <p>
                    @endif
                  </td>
                  <td>
                    ...
                    <input type="text" value="{{$partner->created_at}}" readonly class="inputonly">
                  </td>
                  <td>
                    @if(isset($partner->partner_type))
                    <!-- <p class="partner">{{$partner->partner_type}}</p> -->
                    <input type="text" value="{{$partner->partner_type}}" readonly class="inputonly">
                    @else
                    <p> - <p>
                    @endif
                  </td>
                  <td>
                    ...
                    <input type="text" value="{{$partner->status}}" readonly class="inputonly">
                    @else
                    <p> - <p>
                    @endif
                  </td>
