  ...
  <div class="header__contact">
    <div class="container">
      <div class="fleft contact__infor">
        <a class="contact__phone" href="#"><span><img src="{{asset('frontend/images/call.svg')}}" alt="" style="width:30px; height:18px"/><span>{{$setup->phone}}</span></span></a>
        <a class="contact__email" href="#"><span><img src="{{asset('frontend/images/close-envelope.svg')}}" alt="" style="width:30px; height:18px"/><span>{{$setup->email}}</span></span></a>
